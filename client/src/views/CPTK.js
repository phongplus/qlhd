						...
						<Table responsive="sm" striped bordered hover size="sm" >
							<thead>
								 <tr>
									...
									<th rowspan="2 " width="15%">Nhóm / cá nhân dự trù và tạm ứng</th>
                   				 </tr>
								<tr>
								...
								<tr>
									<th colSpan={9} className='text-left'>A. CHI PHÍ CHUNG</th>
								</tr>
								<tr>
									<th>I</th>
									<th colSpan={8} className='text-left'>Chi phí tiếp khách</th>
								</tr>
								{CTHHs.map(CTHH => ( 
								<tr key={CTHH._id} >
									<td>{stt++}  </td>
								...
								<tr>
									<th>II</th>
									<th colSpan={8} className='text-left'>Chi phí hỗ trợ toàn dự án</th>
								</tr>
								{CTHHs.map(CTHH => ( 
								<tr key={CTHH._id} >
									<td>{stt++}  </td>
								...
								<tr>
									<th colSpan={9} className='text-left'>CỘNG A: </th>
								</tr>
								<tr>
									<th colSpan={9} className='text-left'>B. CHI PHÍ TRIỂN KHAI</th>
								</tr>
								<tr>
									<th>I</th>
									<th colSpan={8} className='text-left'>Giai đoạn I</th>
								</tr>
								{CTHHs.map(CTHH => ( 
								<tr key={CTHH._id} >
									<td>{stt++}  </td>
								...
								<tr>
									<th>II</th>
									<th colSpan={8} className='text-left'>Giai đoạn</th>
								</tr>
								{CTHHs.map(CTHH => ( 
								<tr key={CTHH._id} >
									<td>{stt++}  </td>
								...
								<tr>
									<th colSpan={9} className='text-left'>CỘNG B: </th>
								</tr>
								<tr>
									<th colSpan={9} className='text-left'>TỔNG CHI PHÍ TOÀN DỰ ÁN : A + B </th>
								</tr>
