...
const AddCTHHModal = () => {
	...
	const { tenhang, soluong, dongiaFOB, dongiakho, thanhtiengiakho, dongiaban, thanhtiengiaban,  ghichu } = newCTHH //note
	...
	return (
		<Modal show={showAddCTHHModal} onHide={closeDialog}>
